...
<html lang="en">
<head>
  	<title>IMCA Quiz | Admin Register</title>
  	<meta charset="utf-8">
...
<body>
  <!--   
	<div class="jumbotron text-center" style="margin-bottom:0; padding: 1rem 1rem;">
	   	<img src="../images/logoadmin.png" class="img-fluid" width="100%" alt="Online Examination System in PHP" />
	</div>
  -->
  		...
  		<div class="row">
    		...
    		<div class="col-md-6" style="margin-top:20px;">
    			<span id="message"></span>
      			<div class="card">
        			<div class="card-header" align="center"><h4><b>Admin Registration</b></h4></div>
        			<div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="password" name="confirm_admin_password" id="confirm_admin_password" placeholder="Confirm Password" class="form-control" />
                    </div>
                    <div align="center">
                    <div class="form-group">
