...
<div class="card">
	<div class="card-header">
		<div class="row">
			<div class="col-md-9">
				<h3 class="panel-title">Online Quiz List</h3>
			</div>
		...
		<form method="post" id="exam_form">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="form-group">
						<div class="row">
							<label class="col-md-4 text-right">Quiz Duration <span class="text-danger">*</span></label>
							<div class="col-md-8">
					...
					<div class="form-group">
						<div class="row">
							<label class="col-md-4 text-right">Total No. Questions <span class="text-danger">*</span></label>
							<div class="col-md-8">
...
<div class="modal" id="deleteModal">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<!-- Modal body -->
			<div class="modal-body">
				<h3 align="center">Are you sure you want to remove this quiz?</h3>
			</div>
		...
		$(document).on('click', '.edit', function() {
			...
			$.ajax({
				...
				success: function(data) {
					...
					$('#modal_title').text('Edit Quiz Details');
