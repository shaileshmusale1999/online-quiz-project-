...
if(isset($_POST['page']))
{
    if($_POST['page'] == 'register')
    {
        ...
        if($_POST['action'] == 'register')
        {
            ...
            $subject= 'Online IMCA Quiz Registration Verification';
    ...
    if($_POST["page"] == 'enroll_exam')
    {
        if($_POST['action'] == 'fetch')
        {
            ...
            foreach($result as $row)
            {
                ...
                if($row["online_exam_status"] == 'Started')
                {
                    $view_exam = '<a href="view_exam.php?code='.$row["online_exam_code"].'" class="btn btn-info btn-sm">View Quiz</a>';
                }
                if($row["online_exam_status"] == 'Completed')
                {
                    $view_exam = '<a href="view_exam.php?code='.$row["online_exam_code"].'" class="btn btn-danger btn-sm">View Result</a>';
                }
    ...
    if($_POST['page'] == 'view_exam')
    {
        ...
        if($_POST['action'] == 'user_detail')
        {
            ...
            $output = '
            <div class="card">
                <div class="card-header" align="center"><b>Student Details</b></div>
                <div class="card-body">
                    <div class="row">
            ';
            ...
            foreach($result as $row)
            {
                $output .= '
                <div class="col-md-3">
                    <img src="upload/'.$row["user_image"].'" class="img-fluid img-thumbnail" />
                </div>
                <div class="col-md-9">
...
if($_POST['action'] == 'answer')
        {
            ...
            $marks = 0;
            //alert($orignal_answer);
            //alert($_POST['answer_option']);
