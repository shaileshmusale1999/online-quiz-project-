	...
	<div class="containter">
		<div class="d-flex justify-content-center">
			...
			<div class="card" style="margin-top:50px;margin-bottom: 100px;">
        		<div class="card-header" align="center"><h4><b>Change Password</b></h4></div>
        		<div class="card-body">
	        		<form method="post"	id="change_password_form">
					    ...
					    <div class="form-group">
					        ...
					        <input type="password" name="confirm_user_password" id="confirm_user_password" class="form-control" placeholder="Confirm Password" />
					    </div>
					    <br />
