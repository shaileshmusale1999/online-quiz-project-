	...
	<div class="containter">
		<div class="d-flex justify-content-center">
			...
			<div class="card" style="margin-top:50px;margin-bottom: 100px;">
        		<div class="card-header" align="center"><h4><b>Student Registration</b></h4></div>
        		<div class="card-body">
                ...
                <form method="post" enctype="multipart/form-data" id="user_register_form" >
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="user_email_address" id="user_email_address" placeholder="Enter Email" class="form-control" data-parsley-checkemail data-parsley-checkemail-message='Email Address already Exists' />
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <textarea name="user_address" id="user_address" placeholder="Enter Address" class="form-control"></textarea>
                  </div>
                  <div class="form-group">
                    <label><b>Mobile No.</b></label>
                    <input type="text" name="user_mobile_no" id="user_mobile_no" placeholder="Enter Mobile No." class="form-control" /> 
                  </div>
                  <div class="form-group">
                    <label><b>Profile Image</b></label>
                    <input type="file" name="user_image" accept="image/*" id="file" />
                  </div>
                  <br />
